<form name="edit_blog" action="<?php echo base_url(); ?>super_admin/update_blog" method="post">
    <?php
    ...
    <article class="module width_full">
        ...
        <div class="module_content">
            ...
            <fieldset>
                ...
                <textarea rows="12" name="blog_description" id="ck_editor"><?php echo $blog_info->blog_description;?></textarea><?php //echo display_ckeditor($editor['ckeditor']);?>
            </fieldset>
            <fieldset>
                <label>Blogger Name</label>
                <input type="text" name="blogger_name" value="<?php echo $blog_info->blogger_name;?>">
            </fieldset>
            <fieldset>
                <label>Blogger Email</label>
                <input type="text" name="blogger_email_address" value="<?php echo $blog_info->blogger_email_address;?>">
            </fieldset>
