...
<html lang="en">
    ...
    <body>
        ...
        <section id="secondary_bar">
            <div class="user">
                <p><?php echo $this->session->userdata('admin_name');?> (<a href="#">3 Messages</a>)</p>
        ...
        <aside id="sidebar" class="column">
            ...
            <h3>Content</h3>
            <ul class="toggle">
                <li class="icn_new_article"><a href="<?php echo base_url();?>super_admin/category_form">Add Category</a></li>
                <li class="icn_categories"><a href="<?php echo base_url();?>super_admin/all_category">View Categories</a></li>
                <li class="icn_edit_article"><a href="<?php echo base_url();?>super_admin/add_blog">Add Blog</a></li>
                <li class="icn_categories"><a href="<?php echo base_url();?>super_admin/all_blog">View Blogs</a></li>
                <li class="icn_tags"><a href="<?php echo base_url();?>super_admin/all_comments">All Comments</a></li>
            </ul>
            <h3>Users</h3>
            <ul class="toggle">
                <!--<li class="icn_add_user"><a href="#">Add New User</a></li>-->
                <li class="icn_view_users"><a href="<?php echo base_url();?>super_admin/all_user">View Users</a></li>
